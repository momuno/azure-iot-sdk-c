...
MOCKABLE_FUNCTION(, void, IoTHubTransport_AMQP_Common_SetDeviceTwinCallback, TRANSPORT_LL_HANDLE, handle, IOTHUB_CLIENT_DEVICE_TWIN_CALLBACK, twinCallback, IOTHUB_CLIENT_DEVICE_TWIN_SECTION_CALLBACK, twinSectionCallback);

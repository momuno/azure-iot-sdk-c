...
MOCKABLE_FUNCTION(, IOTHUB_CLIENT_RESULT, IoTHubTransport_MQTT_Common_GetTwinDesiredAsync, IOTHUB_DEVICE_HANDLE, handle, IOTHUB_CLIENT_DEVICE_TWIN_SECTION_CALLBACK, completionCallback, IOTHUB_TWIN_REQUEST_OPTIONS_HANDLE, twinRequestOptions, void*, callbackContext);
MOCKABLE_FUNCTION(, IOTHUB_CLIENT_RESULT, IoTHubTransport_MQTT_Common_GetTwinReportedAsync, IOTHUB_DEVICE_HANDLE, handle, IOTHUB_CLIENT_DEVICE_TWIN_SECTION_CALLBACK, completionCallback, IOTHUB_TWIN_REQUEST_OPTIONS_HANDLE, twinRequestOptions, void*, callbackContext);

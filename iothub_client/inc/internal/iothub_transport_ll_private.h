...
extern "C"
{
    ...
    typedef IOTHUB_CLIENT_RESULT(*pfIoTHubTransport_GetTwinDesiredAsync)(IOTHUB_DEVICE_HANDLE handle, IOTHUB_CLIENT_DEVICE_TWIN_SECTION_CALLBACK completionCallback, IOTHUB_TWIN_REQUEST_OPTIONS_HANDLE twinRequestOptions, void* callbackContext);
    typedef IOTHUB_CLIENT_RESULT(*pfIoTHubTransport_GetTwinReportedAsync)(IOTHUB_DEVICE_HANDLE handle, IOTHUB_CLIENT_DEVICE_TWIN_SECTION_CALLBACK completionCallback, IOTHUB_TWIN_REQUEST_OPTIONS_HANDLE twinRequestOptions, void* callbackContext);

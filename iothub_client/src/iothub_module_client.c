...
IOTHUB_CLIENT_RESULT IoTHubModuleClient_SetModuleTwinCallback(IOTHUB_MODULE_CLIENT_HANDLE iotHubModuleClientHandle, IOTHUB_CLIENT_DEVICE_TWIN_CALLBACK moduleTwinDesiredCallback, void* userContextCallback)
{
...
IOTHUB_CLIENT_RESULT IoTHubDeviceClient_SetModuleTwinDesiredCallback(IOTHUB_MODULE_CLIENT_HANDLE iotHubModuleClientHandle, IOTHUB_CLIENT_DEVICE_TWIN_SECTION_CALLBACK moduleTwinDesiredCallback, void* userContextCallback)
{
    return IoTHubClientCore_SetDeviceTwinDesiredCallback((IOTHUB_CLIENT_CORE_HANDLE)iotHubModuleClientHandle, moduleTwinDesiredCallback, userContextCallback);
}

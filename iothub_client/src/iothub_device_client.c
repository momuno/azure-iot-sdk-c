...
IOTHUB_CLIENT_RESULT IoTHubDeviceClient_SetDeviceTwinDesiredCallback(IOTHUB_DEVICE_CLIENT_HANDLE iotHubClientHandle, IOTHUB_CLIENT_DEVICE_TWIN_SECTION_CALLBACK deviceTwinDesiredCallback, void* userContextCallback)
{
    return IoTHubClientCore_SetDeviceTwinDesiredCallback((IOTHUB_CLIENT_CORE_HANDLE)iotHubClientHandle, deviceTwinDesiredCallback, userContextCallback);
}

...
TEST_FUNCTION(IoTHub_MQTT_GetTwinSectionAsync_e2e_sas)
{
...
TEST_FUNCTION(IoTHub_MQTT_GetTwinSectionAsync_e2e_x509)
{
...
TEST_FUNCTION(IoTHub_MQTT_WS_GetTwinSectionAsync_e2e_x509)
{
